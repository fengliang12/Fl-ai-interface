  ...
  [792],
  {
    93: (e, t, n) => {
      ...
      const H = function (e) {
        ...
        return c().createElement(L.Provider, { value: B({}, n) }, t);
      };
      var $ = function () {
              ...
              return fe(this, function (o) {
                switch (o.label) {
                  ...
                  case 1:
                    return (
                      o.trys.push([1, 5, , 6]),
                      [4, (e = new k.NZ(me, de, n)).getBalance()]
                    );
                  case 2:
      ...
      var je = function (e, t) {
        var n = Se((0, l.useState)(null), 2),
          r = n[0],
          a = n[1],
          o = Se((0, l.useState)(null), 2),
          c = o[0],
          i = o[1],
          u = Se((0, l.useState)(!1), 2),
          s = u[0],
          f = u[1],
          m = Se((0, l.useState)(null), 2),
          p = m[0],
          d = m[1];
        return (
          (0, l.useEffect)(
      ...
      const Te = function () {
          var e = $(),
            ...
            A = v.ensAvatar,
            O = v.isLoading,
            k = Ie(c().useState(null), 2),
            S = k[0],
            j = k[1],
            P = Ie(c().useState(null), 2),
            C = P[0],
            I = P[1],
            T = function () {
              I(null);
