  ...
  ((a.m = o),
    ...
    (a.O = (r, t, o, n) => {
      if (!t) {
        ...
        for (c = 0; c < e.length; c++) {
          for (var [t, o, n] = e[c], i = !0, l = 0; l < t.length; l++)
            (!1 & n || f >= n) && Object.keys(a.O).every((e) => a.O[e](t[l]))
              ? t.splice(l--, 1)
              : ((i = !1), n < f && (f = n));
          if (i) {
            e.splice(c--, 1);
    ...
    (a.t = function (e, o) {
      ...
      for (
        ...
        Object.getOwnPropertyNames(i).forEach((r) => (f[r] = () => e[r]));
