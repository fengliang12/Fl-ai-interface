      ...
      class w {
        ...
        constructor(t) {
          ...
          for (const [a, o] of r) {
            ...
            (t.sort(),
              this.#n.set(a, R(a, i[a]) + t.map((t) => R(t, i[t])).join('')));
          }
        }
        getEncoder(t) {
          let n = this.#e.get(t);
        ...
        _visit(t, n, e) {
          ...
          if (r)
            return (
              ...
              n.map((t) => this._visit(r.prefix, t, e))
            );
          const i = this.types[t];
          if (i)
            return i.reduce(
              (t, { name: r, type: i }) => (
                (t[r] = this._visit(i, n[r], e)),
                t
              ),
              {}
            );
        ...
        static getPrimaryType(t) {
          return w.from(t).primaryType;
        }
        static hashStruct(t, n, e) {
          return w.from(n).hashStruct(t, e);
        }
        static hashDomain(t) {
          const n = [];
          for (const e in t) {
          ...
          return (
            n.sort((t, n) => v.indexOf(t.name) - v.indexOf(n.name)),
            w.hashStruct('EIP712Domain', { EIP712Domain: n }, t)
          );
        }
        static encode(t, n, e) {
          return (0, s.xW)(['0x1901', w.hashDomain(t), w.from(n).hash(e)]);
        }
        static hash(t, n, e) {
          return (0, i.S)(w.encode(t, n, e));
        }
        ...
        static getPayload(t, n, e) {
          ...
          v.forEach((n) => {
            const e = t[n];
            null != e && ((r[n] = M[n](e)), i.push({ name: n, type: g[n] }));
          });
          const c = w.from(n);
          n = c.types;
